...
var createGui = function(){
    ...
    lobao.add (parametrosGui, 'lobaoScale')
        ...
        .onChange(function(value){
            objects["pug"].scale.x  = objects["pug"].scale.y = objects["pug"].scale.z = value;
        }
    );
    ...
    gui.add(parametrosGui, 'lightType')
...
var nossaAnimacao = function () {
    ...
    if (loadFinished){
        ...
        if (moving && objects["pug"]){
            ...
            objects["pug"].position.addScaledVector(dir, moveSpeed * delta * moveDirectionSign);
        }
    }  
...
var onKeyUp = function(e){
    ...
    if ((e.keyCode == 87 || e.keyCode == 38 || e.keyCode == 83 || e.keyCode == 40) && loadFinished){
        if (moving){
            moving = false;
            if (idleAction){
